    ...
    return json_rsp_with_msg(
        ...
        "OK",
        {
            "data": {
                ...
                "enable_announce_pic_popup": get_config()["Player"][
    ...
    return json_rsp_with_msg(
        ...
        "OK",
        {
            "data": {
                ...
                "thirdparty_ignore": {},
                "enable_ps_bind_account": get_config()["Login"][
...
@app.route(
    "/hk4e_global/combo/granter/api/compareProtocolVersion", methods=["POST", "GET"]
)
    ...
    return json_rsp_with_msg(
        ...
        "OK",
        {
            "data": {
                "vals": {
                    "telemetry_config": '{\n"dataupload_enable": 1\n}',
                    "new_register_page_enable": get_config()["Other"][
                        "new_register_page_enable"
                    ],
                    "disable_email_bind_skip": get_config()["Login"][
                    ...
                    "list_price_tierv2_enable": get_config()["Other"][
        ...
        "OK",
        {
            "data": {
                "vals": {
                    ...
                    "enable": get_config()["Other"][
                        "serviceworker"
                    ],  # 是否加载ServiceWorker进行分析
                }
            }
        },
    )
...
def device_report():
    return json_rsp_with_msg(
        repositories.RES_SUCCESS,
        "OK",
        {"data": {"device_fp": "38d7ecd67b187", "code": 200, "msg": "ok"}},  # 假的
    )
...
def consume_remind():
    return json_rsp_with_msg(repositories.RES_SUCCESS, "OK", {"data": []})
